...
export const CUSTOM_INPUT_VALUE_ACCESSOR: any = {
	...
	useExisting: forwardRef(() => TestRadioGroupComponent),
	multi: true
};
...
@Component({
  selector: 'test-radio-group',
  templateUrl: './test-radio-group.component.html',
  styleUrls: ['./test-radio-group.component.css'],
	providers: [CUSTOM_INPUT_VALUE_ACCESSOR]
})
export class TestRadioGroupComponent implements ControlValueAccessor {
